        ...
        <tbody>
            ...
            @foreach ($order as $orderItem)
                <tr>
                  ...
                  <img class="rounded ResponsibeImage" src="{{ asset('Order/' . $orderItem['image']) }}" alt="image">
              </td>
                    ...
                    <td class="text-center">{{ \Illuminate\Support\Str::limit($orderItem['name'], 20) }}</td>
                    ...
                    <td class="text-center d-flex">
                        ...
                        <a href="{{URL::to('/OrderUpdate/Accepted/'.$orderItem['id'])}}" class="mx-auto" id="completed">
                        ...
                        <a href="{{URL::to('/OrderUpdate/Completed/'.$orderItem['id'])}}" class="mx-auto" id="completed">
                            <button  class="btnPrimary mx-1">
                                Complete
                            </button>
                        </a>
                        ...
                        <span class="mx-auto" id="canceled">
                            <a href="{{ URL::to('/Order/'.$orderItem['id']) }}" class="btnDanger mx-1 d-flex">
                                Cancel
                            </a>
                        </span>
                    @endif
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <form method="POST" action="{{URL::to('/OrderDeleted/'.($id??0))}}">
                @csrf
            <button type="submit" class="btnPrimary">Yes</button></form>
            <a href="{{ URL::to('/Order') }}" class="btn btnDanger">No</a>
        </div>
      </div>
    </div>
  </div>
