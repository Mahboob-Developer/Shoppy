        ...
        <div class="row gap-5 mx-2">
            <div class="col-md-4 col-12 p-2 rounded shadow border text-center">
                 <div id="imageContainer">
                    ...
                    <form action="{{ URL::to('/') }}/adminProfile" method="post" enctype="multipart/form-data" class="my-3">
                        @csrf
            ...
            {{-- this is use for enabling form for changing the form from the database  --}}
                <div class="col-md-7 col-12 shadow rounded border p-3">
                    <form method="post" action="{{URL::to('/')}}/ProfileAdminUpdate">
                        @csrf
                        ...
                        <div class="border rounded p-3 mb-3">
                            ...
                            <input type="radio" class="btn-check" name="gender" id="Female" value="Female" {{ $admin['gender']=='female' ? 'checked':''}} autocomplete="on">
                        ...
                        <button  class="btnDanger w-25 mx-1"><a class="nav-link" href="ProfileAdmin">Cancel</a></button></a>
                    </form>
                </div>
        </div>
    </div>
