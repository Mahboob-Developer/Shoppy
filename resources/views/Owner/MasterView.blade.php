      ...
      <div class="sidebar" data-background-color="dark">
        <div class="sidebar-logo">
          ...
          <div class="logo-header " data-background-color="dark">
            <a href="{{URL::to('/Owner')}}" class="d-flex d-block d-md-none ms-5">
              <img
          ...
          />
            ...
            <div class="dropdown float-end  more">
              <img class="rounded-circle" src="{{ empty($admin->image) ? asset('Profile/profile.png') : asset('Profile/'.$admin->image) }}" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false" alt="" style="height:5vh">
              <ul class="dropdown-menu dropdown-user  me-3 text-light" style="background-color: rgb(32, 41, 64)" aria-labelledby="dropdownMenuButton2">
                <div class="dropdown-user-scroll scrollbar-outer">
                  <li>
                    <div class="user-box">
                      <div class="avatar-lg">
                        <img src="{{ empty($admin->image) ? asset('Profile/profile.png') : asset('Profile/'.$admin->image) }}"  alt="image profile"  class="avatar-img rounded"
/>
                  ...
                  <li>
                    ...
                    <a class="text-light ps-3" href="{{URL::to('/Account')}}">My Profile</a>
                    <hr class="text-light my-0 py-0" >
                    <a class="text-light ps-3" href="{{URL::to('/Setting')}}">Account Setting</a>
                    <hr class="text-light my-0 py-0" >
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a href="{{URL::to('/Saller')}}">
                  <i class="fa-solid fa-user-tie  "></i>
                  <p>Saller</p>
                  @if($adminCount != 0)
                      <span class="badge badge-success">{{$adminCount}}</span>
                  @endif
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <a class="dropdown-item" href="{{URL::to('/Account')}}">My Profile</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{URL::to('/Setting')}}">Account Setting</a>
                        <div class="dropdown-divider"></div>
                        <div class="dropdown-item text-light" style="cursor: pointer" onclick="event.preventDefault(); document.getElementById('LogoutForm').submit();" ><i class="fa-sharp fa-solid fa-right-from-bracket"></i>Log out</div>
                      </li>
                    </div>
