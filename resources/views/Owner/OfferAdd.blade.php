...
<div class="container">
    <div class="col-md-6 col-12 border rounded shadow-sm offset-md-3 p-3 mt-3">
        ...
        <form action="{{URL::to('/OfferAdd')}}" method="post" id="OfferAdd" enctype="multipart/form-data">
            @csrf
            <div class="modal-header"></div>

            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="Name" id="Name" placeholder="Enter Offer Name" value="{{ old('Name') }}" />
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="Discount" id="Discount" placeholder="Enter Discount Offer (%)" value="{{ old('Discount') }}" />
            ...
            <div class="form-floating mb-3">
                <input type="date" class="form-control " value="{{ old('starting') }}" name="starting" id="starting" />
            ...
            <div class="form-floating mb-3">
                <input type="date" class="form-control" value="{{ old('ending') }}" name="ending" id="ending" />
